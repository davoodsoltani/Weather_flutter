...
class Alerts {
  ...
  Alerts.fromJson(dynamic json) {
    ...
    _tags = json['tags'] != null ? json['tags'].cast<String>() as List<String> : [];
  }
  String? _senderName;
  String? _event;
  int? _start;
...
class Daily {
  ...
  Daily.fromJson(dynamic json) {
    ...
    _moonPhase = json['moon_phase'].toDouble() as double;
    ...
    _dewPoint = json['dew_point'].toDouble() as double;

    _windSpeed = json['wind_speed'].toDouble() as double;
    _windDeg = json['wind_deg'] as int;
    _windGust = json['wind_gust'].toDouble() as double;
...
class Feels_like {
  ...
  Feels_like.fromJson(dynamic json) {
    _day = json['day'].toDouble() as double;
    _night = json['night'].toDouble() as double;
    _eve = json['eve'].toDouble() as double;
    _morn = json['morn'].toDouble() as double;
  }
  double? _day;
  double? _night;
  double? _eve;
...
class Temp {
  ...
  Temp.fromJson(dynamic json) {
    _day = json['day'].toDouble() as double;
    _min = json['min'].toDouble() as double;
    _max = json['max'].toDouble() as double;
    _night = json['night'].toDouble() as double;
    _eve = json['eve'].toDouble() as double;
    _morn = json['morn'].toDouble() as double;
  }
...
class Current {
  ...
  Current.fromJson(dynamic json) {
    ...
    _humidity = json['humidity'] as int;
    _dewPoint = json['dew_point'].toDouble() as double;
    _uvi = json['uvi'].toDouble() as double;
    _clouds = json['clouds'] as int;
